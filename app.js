...
const { SAS_TOKEN, STORAGE_ACCOUNT_NAME, CONTAINER_NAME_VIDEOS, CONTAINER_NAME_GIFS, CONTAINER_NAME_THUMBNAILS, CONTAINER_NAME_CATALOGS } = require('./config/config');
...
async function initializeApp() {
    ...
    const catalogsFiles = await getFilesData(CONTAINER_NAME_CATALOGS, STORAGE_ACCOUNT_NAME, SAS_TOKEN);
